      ...
      courseAgenda.forEach((courseAgendaRecord) => {
        ...
        courseGongsDays.forEach((courseDay) => {
          ...
          courseGongs.times.forEach((gongTimeStr) => {
            const gongTimeFromCourseStart = moment.duration(courseDay + '.' + gongTimeStr);
            const timedGong = new ManualGong(gongTimeFromCourseStart.asMilliseconds(), newGong);
            timedGongsArray.push(timedGong);
